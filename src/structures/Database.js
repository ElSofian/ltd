...
module.exports = class Database {
    ...
    async createEmployee(carnetId, userId, characterId, firstName, lastName, birthDate, grade, speciality, phone, iban) {
        if (!speciality) speciality = "nothing";
        const query = await this._query("INSERT INTO employees (carnet_id, user_id, character_id, first_name, last_name, birth_date, grade, phone, iban) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)",
			[carnetId, userId, characterId, firstName, lastName, birthDate, grade, phone, iban]);
